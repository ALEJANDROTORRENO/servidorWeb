    ...
    async iniciaSeccio () {
        ...
        if (objRebut.resultat === 'ok') {
            for (cntProducte = 0; cntProducte < objRebut.missatge.length; cntProducte = cntProducte + 1) {
                ...
                codiHTML = codiHTML + '<img id="p'+cntProducte+'i0" src="' + imatges[0] + '" width="400" height="200" />'
                codiHTML = codiHTML + '<img id="p'+cntProducte+'i1" src="' + imatges[1] + '" class="none" width="400" height="200" />'
                codiHTML = codiHTML + '<img id="p'+cntProducte+'i2" src="' + imatges[2] + '" class="none" width="400" height="200" />'
